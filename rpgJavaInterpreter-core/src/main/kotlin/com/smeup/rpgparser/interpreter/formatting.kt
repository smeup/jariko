...
internal fun DecimalValue.formatAs(
    format: String,
    type: Type,
    decedit: DecEdit,
    padChar: Char = ' ',
    ...
    fun getWrkTotalLength(): Int = t.decimalDigits + t.entireDigits
    ...
    fun italianDecimalFormatWithNoThousandsSeparator(type: NumberType) =
        DecimalFormat(
            ...
            DecimalFormatSymbolsRepository.italianSymbols,
        ).format(decValue.abs())
    ...
    fun fY(): String {
        ...
        if (testLen <= 2) {
            ...
            stringN =
                "${toBlank(stringN[0])}${stringN[1]}${stringN[2]}/${stringN[3]}${stringN[4]}/${stringN[5]}${stringN[6]}".padStart(
                    wrkTotalLength + 2,
                )
        } else if (testLen == 8) {
            // "nnn⁄nn⁄nn"
            ...
            stringN =
                "${toBlank(
                    stringN[0],
                )}${stringN[1]}/${stringN[2]}${stringN[3]}/${stringN[4]}${stringN[5]}${stringN[6]}${stringN[7]}".padStart(
                    wrkTotalLength + 2,
                )
        } else if (testLen == 9) {
            // "nnn⁄nn⁄nnnn"
            ...
            stringN =
                "${toBlank(
                    stringN[0],
                )}${stringN[1]}${stringN[2]}/${stringN[3]}${stringN[4]}/${stringN[5]}${stringN[6]}${stringN[7]}${stringN[8]}".padStart(
                    wrkTotalLength + 2,
                )
        } else {
...
internal fun DecimalValue.formatAsWord(
    format: String,
    type: Type,
): StringValue {
    ...
    val wholeNumberAsString =
        this
            .significantDigitsAsStringJustDigits(type)
    ...
    format.reversed().forEachIndexed { i, formatChar ->
...
private fun decimalPattern(type: NumberType) =
    buildString {
        append("#,###")
        append(decimalsFormatString(type))
    }
