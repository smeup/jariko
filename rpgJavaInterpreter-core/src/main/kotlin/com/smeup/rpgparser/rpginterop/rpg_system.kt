...
object RpgSystem {
    ...
    internal var programFinders: LinkedHashSet<RpgProgramFinder> = Collections.synchronizedSet(LinkedHashSet<RpgProgramFinder>()) as LinkedHashSet<RpgProgramFinder>
