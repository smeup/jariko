...
class Kute10_54 : Kute() {
    ...
    fun performanceComparing(doAsserts: Boolean): Array<String> {
        ...
        var message2 = "Expected execution of ${eval(
            statement.endValue,
        ).asInt()} iterations ($loopCounter done) takes less or same to $expectedElapsedTimeInMillisec ms. Actual is $actualElapsedTimeInMillisec ms."
        if (doAsserts) {
