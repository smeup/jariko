...
fun compileAllMutes(
    ...
    dirs.forEach { it ->
        ...
        if (compiled.any { it.error != null }) {
            System.err.println("\nErrors during compilation of these programs, for details search program name in the logs above:")
            System.err.print("*".repeat(80))
            System.err.println()
            compiled.filter { it.error != null }.forEach { compilationResult ->
                System.err.println(compilationResult.srcFile)
            }
            System.err.print("*".repeat(80))
            System.err.println()
            System.err.println()
