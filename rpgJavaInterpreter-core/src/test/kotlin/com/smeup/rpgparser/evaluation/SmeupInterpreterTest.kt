...
open class SmeupInterpreterTest : AbstractTest() {
    ...
    /*
    AS400 response when operation are passed as %CHAR parameters (second test):
    ...
    */
    ...
    fun executeT04_A70() {
        val expected = listOf(
            "I_SUM(654360) I_DIF(654280) I_MUL(26172800) I_DIV(16358) P_SUM(588.04) P_DIF(654232.86) P_MUL(43648.42) P_DIV(7508.83) S_SUM(472.600) S_DIF(408.200) S_MUL(14180.880) S_DIV(13.677) U_SUM(400) U_DIF(240) U_MUL(25600) U_DIV(4)",
