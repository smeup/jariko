...
open class SmeupInterpreterTest : AbstractTest() {
    ...
    fun executeT04_A20() {
        val expected =
            listOf(
                "CALL_1(MULANGT04 , 1, MULANGTB10: MULANGT04 chiamata 1                  ) CALL_2(MULANGT04 , 3, MULANGTB10: MULANGT04 chiamata 1                  )",
            )
    ...
    fun executeT10_A70() {
        val expected =
            listOf(
                "CAT_1(MR. SMITH) CAT_2(RPG/400) CAT_3(RPG/4)",
                "CAT_1(ABC  XYZ ) CAT_2(Mr. Smith)",
                "CAT_1(RPG/400   )",
                "CAT_1(RPGIV     )",
            )
    ...
    fun executeT16_A20() {
        val expected =
            listOf(
                ...
                "(Somewhere else: Ontario, Ontario, California     )",
            )
    ...
    fun executeT40_A10() {
        val expected =
            listOf(
                "A10_DS_P01(BBB                 -.000000000-.000000000-0-0-0-0) A10_DS_P04(AAA                 -.000000000-.000000000-0-0-0-0)",
            )
    ...
    fun executeT40_A10_P01() {
        val expected =
            listOf(
                "Lunghezza: 32580 Contenuto:                     -          -          -          -          -          -          -                                                                                                                                                                                                                                                                -          -          -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                -.000000000-.000000000-                                                                                                   -0-          -0-0-          -0",
            )
    ...
    fun executeT60_A10_P01() {
        val expected =
            listOf<String>(
                "KA(0)KB(0)KC(0)KD(0)KE(0)KF(0)KG(0)KH(0)KI(0)KJ(0)KK(0)KL(0)KM(0)KN(0)KP(0)KQ(0)KR(0)KS(0)KT(0)KU(0)KV(0)KW(0)KX(0)KY(0)",
            )
    ...
    fun executeT40_A30_P01() {
        val expected =
            listOf("Lunghezza: 32580 Contenuto:                     -          -          -          -          -          -          -")
