    ...
    fun testMainUnspecified() {
        ...
        val conf =
            Configuration(
                jarikoCallback =
                    JarikoCallback(
                        getActivationGroup = { _: String, associatedActivationGroup: ActivationGroup? ->
    ...
    fun testCallCaller() {
        ...
        val conf =
            Configuration(
                jarikoCallback =
                    JarikoCallback(
                        getActivationGroup = { executingProgramName: String, associatedActivationGroup: ActivationGroup? ->
