   COP* *NOUI
    ...
    MU* VAL1(FI07(80)) VAL2(999999999999,999) COMP(EQ)
    MU* VAL1(FI07A(80)) VAL2('999999999999999') COMP(EQ)
    MU* VAL1(FI07(99)) VAL2(999999999999,999) COMP(EQ)
    MU* VAL1(FI07A(99)) VAL2('999999999999999') COMP(EQ)
