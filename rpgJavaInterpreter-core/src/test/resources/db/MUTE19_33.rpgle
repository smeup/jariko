     ...
     D*  SETLL READE su VERAPG0F con chiavi diverse
     D*  Programma SPL: 33_SetllAndReadE_DiffKey_100_VERAPG0F
     V*=====================================================================
    ...
    MU* VAL1(RESULT) VAL2(100) COMP(EQ)
     ...
     C                   EVAL      MU_TSNAME = '33_SetllAndReadE_DiffKey'       COSTANTE
