    ...
    O *  `Cannot assign DataStructValue to StringType`.
     ...
     C                   EVAL      A40_DS1=A40_A50                              Jariko Runtime Error: `MOVE/MOVEL not supported for the type: DataStructureType...`
     C     A40_DS1_F1    DSPLY
     C     A40_DS1_F2    DSPLY
     C     A40_DS1_F3    DSPLY
     ...
     C                   EVAL      A40_DS2=A40_A50                              Jariko Runtime Error: `MOVE/MOVEL not supported for the type: DataStructureType...`
     C     A40_DS2_F1    DSPLY
     C     A40_DS2_F2    DSPLY
     C     A40_DS2_F3    DSPLY
