     ...
     D A70_UR          S              5U 0
      **************************************************************************
      * %CHAR called on variables that contains operations results (supported case)
     C                   CLEAR                   DBG_Str
     C                   EVAL      A70_IR=A70_I7+A70_I8
     ...
     C                             ' I_DIV('+ %CHAR(A70_IR)+')'
      *
     C                   EVAL      A70_PR=A70_P7+A70_P8
     C                   EVAL       DBG_Str=%TRIMR(DBG_Str)+                             
     C                             ' P_SUM('+ %CHAR(A70_PR)+')'
     C                   EVAL      A70_PR=A70_I7-A70_P8
     C                   EVAL       DBG_Str=%TRIMR(DBG_Str)+                             
     C                             ' P_DIF('+ %CHAR(A70_PR)+')'
     C                   EVAL      A70_PR=A70_P7*A70_P8
     C                   EVAL       DBG_Str=%TRIMR(DBG_Str)+                             
     ...
     C                             ' U_DIV('+ %CHAR(A70_UR)+')'
     C     DBG_Str       DSPLY
      * %CHAR called with operations in function parameter (not supported)
     C                   CLEAR                   A70_A1
     C                   EXSR      SUB_A70_B
