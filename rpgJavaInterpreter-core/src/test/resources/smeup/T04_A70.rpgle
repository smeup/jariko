     ...
     D A70_U4          S              5U 0 INZ(320)
     D A70_U5          S              5U 0 INZ(080)
      **************************************************************************
      * %CHAR con operazioni numeriche
     C                   CLEAR                   A70_A1
     C                   EXSR      SUB_A70_B
     C                   EVAL      DBG_Str=A70_A1
      * %CHAR con operazioni numeriche (100.000 volte)
     C                   CLEAR                   A70_A1
     C                   DO        NNN
     C                   EXSR      SUB_A70_B
     C                   ENDDO
    ...
    RD* Subsezione di SEZ_A70 P09 e P10
     ...
     C                             +'U_SUM('+%CHAR(A70_U4+A70_U5)+') '
     C                             +'U_DIF('+%CHAR(A70_U4-A70_U5)+') '
     C                             +'U_MUL('+%CHAR(A70_U4*A70_U5)+') '
     C                             +'U_DIV('+%CHAR(A70_U4/A70_U5)+') '
      *
     C                   ENDSR