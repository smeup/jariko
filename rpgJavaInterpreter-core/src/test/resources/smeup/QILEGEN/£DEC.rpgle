     ...
     V* 27/08/24  V6R1    BMA Aggiunta definizione fittizia campi £PDS
     V*                   per non dover includere la £PDS
     V* ==============================================================
     D* OBIETTIVO
     ...
     D*C     N35 36          SETON                     10
     D*-------------------------------------------------------------------
     D/COPY QILEGEN,£DECDS
     D/COPY QILEGEN,£TABB£1DS
      *D/COPY QILEGEN,£PDS
      *--------------------------------------------------------------------------------------------*
     C     £DEC          BEGSR
      * Campi £PDS definiti inline per poter rimuovere la /COPY
      * La presenza della £PDS era problematica rispetto all'uso
      * di /API perché la DS definita nel MAIN del programma
      * poteva essere differente per l'aggiunta di sottocampi
1    C                   MOVEL     ££ATCO        ££ATCO            1
     C                   MOVEL     ££AMBI        ££AMBI           10
     C                   MOVEL     ££CONT        ££CONT           10
     C                   Z-ADD     ££DATE        ££DATE            8 0
     C                   MOVEL     £PDSNP        £PDSNP           10
      *
     C                   IF        ££ATCO<>''
1    C                   IF        £DECAM=''
     C                   MOVEL     ££AMBI        £DECAM
