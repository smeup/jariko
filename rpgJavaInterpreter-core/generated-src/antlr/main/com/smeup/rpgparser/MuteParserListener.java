...
public interface MuteParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MuteParser#byExpression}.
	 * @param ctx the parse tree
	 */
	void enterByExpression(MuteParser.ByExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link MuteParser#byExpression}.
	 * @param ctx the parse tree
	 */
	void exitByExpression(MuteParser.ByExpressionContext ctx);
	/**
	 * Enter a parse tree produced by {@link MuteParser#stopExpression}.
	 * @param ctx the parse tree
	 */
	void enterStopExpression(MuteParser.StopExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link MuteParser#stopExpression}.
	 * @param ctx the parse tree
	 */
	void exitStopExpression(MuteParser.StopExpressionContext ctx);
	/**
