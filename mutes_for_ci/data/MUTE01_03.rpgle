   COP* *NOUI
     ...
     V* 04/10/16  V5.R1 GIAGIU Implementazioni
     V* B£61020C  V5R1    BMA Aggiunta COP* *NOUI
     V* 28/12/16  V5R1  GIAGIU Verifiche su campi numerici lunghi 20
     V* 25/01/17  V5R1  GIAGIU Implementazioni di test
     V* 07/02/17  V5R1  GIAGIU Implementazioni di test
     V* 21/02/17  V5R1  FORDAR Implementazioni di test
     V* 16/03/17  V5R1  GIAGIU Implementazioni di test
     V*=====================================================================
     V* OBIETTIVO
     V*  Programma finalizzato ai test su campi di tipo DECIMAL ZONED
     V*
     V*=====================================================================
     DS0               S              1S 0
